...
public class Aluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCPFFormat = new javax.swing.JFormattedTextField();
        ...
        try {
            txtCPFFormat.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###.###.###-##")));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(avisoFone, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnSalvaInfoAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvaInfoAlunoActionPerformed
        ...
        String cpfSemFormato = cpfFormatado.replaceAll("[^\\d]", "");
        String cpf = cpfSemFormato.trim();
        ...
        if (campoVazio) {
            ...
            conecta.executaSQL("SELECT * FROM alunos WHERE cpf = '" + modAluno.getCpf() + "'");
            try {
    ...
    private void btnBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaActionPerformed
        ...
        if (clickTabela || novo) {
            ...
            limpaCampos(txtDtNascimento, txtNome, txtEmail, txtTelefone);
            desabilitaCampos(txtDtNascimento, txtEmail, txtTelefone);
            btnTreinos.setEnabled(false);
        }
        ...
        } else if (!"".equals(cpfSemFormato)) {
            preencherTabela("SELECT * FROM alunos WHERE cpf LIKE '%" + cpfSemFormato + "%'");
    ...
    private void tblAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAlunosMouseClicked
        ...
        if (novo) {
            ...
            txtCPFFormat.setText(tblAlunos.getValueAt(linha, 2).toString());
            txtCPF.setText(txtCPFFormat.getText());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        habilitaCampos(txtDtNascimento, txtEmail, txtTelefone,btnSalvaInfoAluno,btnExcluir);
    ...
    private javax.swing.JFormattedTextField txtCPFFormat;
