...
public class Treino extends javax.swing.JFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        conectaTreino.executaSQL("SELECT * FROM treinos WHERE id_treino = '" + txtIDTreino.getText() + "'");

            try {
                if(conectaTreino.rs.next()){
                    Date dataSql = conectaTreino.rs.getDate("data_inicio");
                    
                    if(dataSql != null){
                        LocalDate data = dataSql.toLocalDate();
                        String dataFormatada = data.format(formatoData);
                        txtDtInicio.setText(dataFormatada);
                    }else{
                        txtDtInicio.setText("");
                    }
                }
